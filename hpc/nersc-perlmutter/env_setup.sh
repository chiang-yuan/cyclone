...
#ZZfunc_trap() {
#ZZ######################################################
#ZZ# -------------- checkpoint application --------------
#ZZ######################################################
#ZZ    # insert checkpoint command here if any
#ZZ    $ckpt_command 
#ZZ    scontrol requeue ${SLURM_JOB_ID}
#ZZ    scontrol update JobId=${SLURM_JOB_ID} TimeLimit=${requestTime}
#ZZ    echo \$?: $?
#ZZ}
